...
<head>
	...
	<title>ceder plank salmon</title>
...
<body>
			...
			<div class="row">
				...
				<div class="details_2 clearfix ">
					...
					<div class="col-sm-6">
						...
						<div class="details_5">
							<a href="#"><img src="img/soloman R1.jpg" alt="abc" class="img_responsive"></a>
						</div>
					</div>
	...
	<section id="product_bio">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<strong>Atcitve Time</strong> <span> 30 Minutes</span>
					<blockquote>
						<p class="recp-intro">
							The salmon takes on a light, smoky woodiness from grilling on a cedar plank, for a lovely pairing of earth and ocean.</p>
				...
				<div class="col-sm-6">
					...
					<div class="details_4">
						<ul>
							<li class="well_1"><i class="fa fa-leaf"></i>3 (12 inch) untreated cedar planks</li>

							<li class="well_1"><i class="fa fa-leaf"></i>⅓ cup soy sauce</li>


							<li class="well_1"><i class="fa fa-leaf"></i>⅓ cup vegetable oil
							</li>

							<li class="well_1"><i class="fa fa-leaf"></i>1 ½ tablespoons rice vinegar</li>
							<li class="well_1"><i class="fa fa-leaf"></i>1 teaspoon sesame oil</li>
							<li class="well_1"><i class="fa fa-leaf"></i>¼ cup chopped green onions</li>
							<li class="well_1"><i class="fa fa-leaf"></i>1 tablespoon grated fresh ginger</li>
							<li class="well_1"><i class="fa fa-leaf"></i>1 teaspoon minced garlic</li>
				...
				<div class="col-md-12">
					<div class="video_content">
						<div class="embed-responsive embed-responsive-16by9">
							<iframe class="embed-responsive-item" width="100%" height="500px" src="https://www.youtube.com/embed/LbF401Q-Rls" allowfullscreen></iframe>
						</div>
					</div>
				</div>
			</div>
