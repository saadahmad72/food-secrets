...
<head>
	...
	<title>chicken cheese burger</title>
			...
			<div class="row">
				...
				<div class="details_2 clearfix ">
					...
					<div class="col-sm-6">
						...
						<div class="details_5">
							<a href="#"><img src="img/chicken cheese burger R5.jpg" alt="abc" class="img_responsive"></a>
						</div>
					</div>
					<div class="col-sm-6 details_main_1">
						...
						<p>Craving for some cheesy delight? If yes, then we have a nice delectable recipe for you. Here's a super-delicious yet easy-to-make Chicken Cheese Burger recipe which is going to drive any cheese lover crazy! </p>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					...
					<blockquote>
						<p class="recp-intro">
							Craving for some cheesy delight? If yes, then we have a nice delectable recipe for you. Here's a super-delicious yet easy-to-make Chicken Cheese Burger recipe which is going to drive any cheese lover crazy!</p>
				...
				<div class="col-sm-6">
					...
					<div class="details_4">
						<ul>
							<li class="well_1"><i class="fa fa-leaf"></i>3 burger buns</li>

							<li class="well_1"><i class="fa fa-leaf"></i>3 slices cheese slices
							</li>


							<li class="well_1"><i class="fa fa-leaf"></i>1/4 cup ranch dressing</li>
							<li class="well_1"><i class="fa fa-leaf"></i>2 tablespoon refined oil
							</li>
							<li class="well_1"><i class="fa fa-leaf"></i>2 halved chicken breasts
							</li>

							<li class="well_1"><i class="fa fa-leaf"></i>1/4 cup salsa sauce
							</li>
							<li class="well_2">3 lettuce loose-leaf
							</li>
				...
				<div class="col-md-12">
					<div class="video_content">
						<div class="embed-responsive embed-responsive-16by9">
							<iframe class="embed-responsive-item" width="100%" height="500px" src="https://www.youtube.com/embed/ggVQY1J-pwk" allowfullscreen></iframe>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="col-xl-4 col-lg-4 col-md-6">
							<div class="footer-widget">
								...
								<ul>
									...
									<li><a href="recipes.php">Resipes</a></li>
